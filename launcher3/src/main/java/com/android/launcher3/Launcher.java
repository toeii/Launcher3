...
public class Launcher extends Activity
    ...
    private static final int REQUEST_ADDED_APPWIDGET = 111;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        for (AppWidgetProviderInfo pInfo : widgets) {
            ...
            if(info.label.equals("lxm_launcher_widget")){
                mPendingAddInfo.id = 9527;
                mPendingAddInfo.screenId = 1;
                mPendingAddInfo.container = -100;
                mPendingAddInfo.spanX = 4;
                mPendingAddInfo.spanY = 2;
                mPendingAddInfo.cellX = 0;
                mPendingAddInfo.cellY = 0;
                ...
                startActivityForResult(intent, REQUEST_ADDED_APPWIDGET);
            }
        }
...
//        }
    ...
    private void handleActivityResult(
        ...
        if (requestCode == REQUEST_BIND_APPWIDGET) {
            ...
            return;
        } else if (requestCode == REQUEST_ADDED_APPWIDGET) {
