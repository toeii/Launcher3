...
import com.android.launcher3.util.SystemUtil;
...
public class InvariantDeviceProfile {
    ...
    private static float SMALL_ICON_SIZE_DP = 48;
    private static float DEFAULT_ICON_SIZE_DP = 56;
    private static float BIG_ICON_SIZE_DP = 60;
    ...
    public InvariantDeviceProfile(InvariantDeviceProfile p) {
        this(p.name, p.minWidthDps, p.minHeightDps, p.numRows, p.numColumns,
                ...
                p.defaultLayoutId,p.defaultNoAllAppsLayoutId);
    }

    InvariantDeviceProfile(String n, float w, float h, int r, int c, int fr, int fc, int maapc,
                           float is, float its, float hs, float his, int dlId,int dlId2) {
...
//            throw new RuntimeException("All Device Profiles must have an odd number of hotseat spaces");
        ...
        defaultNoAllAppsLayoutId = dlId2;
...
//            throw new RuntimeException("All Device Profiles must have an odd number of hotseat spaces");
    ...
    private int getLauncherIconDensity(int requiredSize) {
        ...
        for (int i = densityBuckets.length - 1; i >= 0; i--) {
            float expectedSize = DEFAULT_ICON_SIZE_DP * densityBuckets[i]
